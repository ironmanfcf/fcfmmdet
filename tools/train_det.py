...
def parse_args():
    ...
    parser.add_argument('--config', default='/opt/data/private/fcf/mmdetection/tools/work_dirs/DeCoDet/fcos_r50-caffe_fpn_gn-head_DeCoDet-V16_1x_hazydetcoco/fcos_r50-caffe_fpn_gn-head_1x_hazydetcoco.py', help='train config file path')
