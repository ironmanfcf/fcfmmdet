...
class FCOSDepthHead(FCOSHead):
    ...
    def loss_by_feat(
        ...
        # print("len(cls_scores):", len(cls_scores))
        # print("len(seg_scores):", len(seg_scores))
        assert len(cls_scores) == len(seg_scores)
        ...
        # min_target =torch.min(flatten_seg_targets)
        # max_target =torch.max(flatten_seg_targets)

        # print("label最小值:", min_target.item())
        # print("label最大值:", max_target.item())
        ...
        # loss_seg = loss_seg.sqrt()
        # print("flatten_seg_targets.unique():", flatten_seg_targets.unique())
        # print("flatten_labels.unique():", flatten_labels.unique())
        # print("flatten_labels.unique().dtype:", flatten_labels.unique().dtype)
        ...
        # print("loss_seg inside loss_by_feat:", loss_seg)
        return dict(
            loss_cls=loss_cls,
            loss_bbox=loss_bbox,
